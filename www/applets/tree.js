function refreshAlign(data){
    ...
    for (var result of data){
        ...
        style="position:relative;width: 98%;height:20%;background: #ffffff42;margin:1%;">
...
*/
document.getElementById("yanhuashuEntries").innerHTML = data;
}
